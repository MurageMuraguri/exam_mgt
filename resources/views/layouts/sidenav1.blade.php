...
{{--        <ul class="navbar-nav">--}}
{{--            <li class="nav-item">--}}
{{--                <a class="nav-link text-white active bg-gradient-info" href="{{ route('home') }}">--}}
...
{{--            </li>--}}
{{--            --}}{{--            @if ()--}}
{{--            <li class="na--}}{{-- @extends('layouts.dashApp') --}}
{{--@extends('layouts.dashApp')--}}
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white" href="{{ route('my_activities') }}">
                    ...
                    <span class="nav-link-text ms-1">My activities</span>
                </a>
            </li>
{{--            @if ()--}}
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('my_schedule')}}">
                    <div class="text-center me-2 d-flex align-items-center justify-content-center text-white">
...
{{--            </li>--}}
            <li class="nav-item">
                <a class="nav-link text-white" href="{{route('my_deadline')}}">
                    <div class="text-center me-2 d-flex align-items-center justify-content-center text-white">
                        <i class="material-icons opacity-10">feed</i>
                    </div>
                    <span class="nav-link-text ms-1">Deadlines</span>
                </a>
            </li>
