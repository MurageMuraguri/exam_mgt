                        ...
                        <ul class="list-group">
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <form method="POST" enctype="multipart/form-data" id="upload-file" action="{{ url('submit_ex') }}" >
                                        @csrf
                                        ...
                                        <input type="hidden" name="uploaded_by" value="{{$exam_details->external_examiner_id}}">
